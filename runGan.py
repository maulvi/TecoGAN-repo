...
if( runcase == 0 ): # download inference data, trained models
    ...
    cmd2 = "wget https://github.com/maulvi/TecoGAN-repo/releases/download/v1.0/vid3_LR.zip -O LR/vid3.zip;"
    cmd2 += "unzip LR/vid3.zip -d LR; rm LR/vid3.zip"
    subprocess.call(cmd2, shell=True)
    
    cmd2 = "wget https://github.com/maulvi/TecoGAN-repo/releases/download/v1.0/tos_LR.zip -O LR/tos.zip;"
    cmd2 += "unzip LR/tos.zip -d LR; rm LR/tos.zip"
    subprocess.call(cmd2, shell=True)
    
    # download the ground-truth data
    if(not os.path.exists("./HR/")): os.mkdir("./HR/")
    cmd3 = "wget https://github.com/maulvi/TecoGAN-repo/releases/download/v1.0/vid4_HR.zip -O HR/vid4.zip;"
    cmd3 += "unzip HR/vid4.zip -d HR; rm HR/vid4.zip"
    subprocess.call(cmd3, shell=True)
    
    cmd3 = "wget https://github.com/maulvi/TecoGAN-repo/releases/download/v1.0/tos_HR.zip -O HR/tos.zip;"
